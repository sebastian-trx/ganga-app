...
const Slideshow2 = ({
  ...
  const siguiente = useCallback(() => {
    ...
    if (slideshow?.current?.children?.length > 0) {
      ...
      // Establezco la transicion para el slideshow.
      ...
      const transicion = () => {
        ...
        // Tomo el primer elemento y lo mando al final.
  ...
  useEffect(() => {
    if (autoplay) {
      ...
      // Elimino los intervalos
      slideshow.current.addEventListener("mouseenter", () => {
        clearInterval(intervaloSlideshow.current);
      });

      // Vuelvo a poner el intervalo cuando saco el cursor del slideshow
...
export { Slideshow2, Slide, TextoSlide };
