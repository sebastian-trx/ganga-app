...
export default function ReviewVendor({ idUser, idProduct }) {
            ...
            <form>
                ...
                <div class=" my-1">
                    <textarea
                        ...
                        name="description"
                        type="text"
                        placeholder="¿Que te parecio el vendedor?"
                ...
                <div class=" my-1">
                    ...
                    <div>
                        <button
                            className="border-gray-400 border-2 rounded ml-16 px-1 m-2 mb-10 text-s"
                            value="submit"
