...
import { getUserInfoGoogle, failMail } from "../Redux/Actions/actions";
          ...
          <div class="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y md:w-4/5 lg:w-4/5">
            <div class="flex-1">
              <th class="w-full text-sm lg:text-base" cellspacing="0">
                <button onClick={volver} class="flex justify-center w-full px-4 py-2 font-medium text-white uppercase bg-gray-800 rounded-full shadow item-center hover:bg-red-500 focus:shadow-outline focus:outline-none">
