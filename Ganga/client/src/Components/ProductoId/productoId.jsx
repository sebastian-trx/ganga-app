...
import { getDetailsProduct,addProduct, getUserInfoGoogle} from "../Redux/Actions/actions";
...
export default function ProductId() {
  ...
  function handleAddToCart() {
    ...
    dispatch(addProduct({id: User.id, item: {id: info.id}, cant: 1, que: "+"}))
    navigate("/shopCart");
  }
          ...
          <>
            ...
            <div className={a.izq}>
              ...
              <div className={a.div3}>
                ...
                <button onClick={handleAddToCart} className={a.bnt}>Agregar al carrito</button>
              </div>
            </div>
          </>
        </div>
